...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openff-utilities-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12776&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openff-utilities-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openff-utilities` can be installed with:

```
conda install openff-utilities
```

It is possible to list all of the versions of `openff-utilities` available on your platform with:
